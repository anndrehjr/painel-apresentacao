  ...
  return (
    <section id="servicos">
      ...
      <div id="card-container">
        <div className="card">
          <img src="/images/desenvolvedor-web.jpg" alt="Desenvolvimento Web" />
        ...
        <div className="card">
          <img src="/images/Design Gráfico.png" alt="Design Gráfico" />
          <h2>Design Gráfico</h2>
          <p>Criação de logotipos, banners, cartões de visita e identidade visual.</p>
          <a href="https://wa.me/5518996791377" className="button">Enviar WhatsApp</a>
        </div>
        <div className="card">
          <img src="/images/MD.jpeg" alt="Marketing Digital" />
          <h2>Marketing Digital</h2>
          <p>Gerenciamento de redes sociais, criação de conteúdo e anúncios.</p>
          <a href="https://wa.me/5518996791377" className="button">Enviar WhatsApp</a>
        </div>
        <div className="card">
          <img src="/images/personalizados-03.webp" alt="Artigos Personalizados" />
